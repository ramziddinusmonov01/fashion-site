      ...
      <div class="nav-show" :class="{ active: show_lang }">
        <div class="nav-modal" :class="{ 'active-modal': active_navModal }">
          ...
          <div class="nav-modal__list">
            <NuxtLink class="nav__list-item" to="/">Главная</NuxtLink>
            <NuxtLink class="nav__list-item" to="/">Новинки</NuxtLink>
            <NuxtLink class="nav__list-item" to="/">Скидки</NuxtLink>
            <NuxtLink
                  ...
                  <div class="nav-modal__dropdown--list">
                    <div class="nav-modal__dropdown--list--item">
                      ...
                      <div class="nav-modal__dropdown--list--flex">
                        <h2><NuxtLink to="/">Dresses</NuxtLink></h2>
                      </div>
                    </div>
                    <div class="nav-modal__dropdown--list--item">
                    ...
                    <div class="nav-modal__dropdown--list--item">
                      ...
                      <div class="nav-modal__dropdown--list--flex">
                        <h2>
                          <NuxtLink to="/">Outerwear</NuxtLink>
                        </h2>
                      </div>
                    </div>
                  </div>
